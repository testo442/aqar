...
export const applyPage = {
  ...
  input: "w-full h-11 rounded-2xl bg-background border border-border text-sm text-slate-900 placeholder:text-slate-400 outline-none px-4 focus:border-primary-400 focus:ring-1 focus:ring-primary-200 transition-colors duration-150",
  ...
  photoAdd: "w-20 h-20 rounded-xl border-2 border-dashed border-border bg-background flex-shrink-0 flex flex-col items-center justify-center gap-1 text-slate-400 hover:text-slate-600 hover:border-slate-400 transition-colors duration-150 cursor-pointer",
...
export const propertyDetail = {
  ...
  heroSave: "absolute top-3 right-3 rtl:right-auto rtl:left-3 z-10 h-9 w-9 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center shadow-sm border border-border transition-colors duration-150",
...
export const filterSheet = {
  ...
  closeBtn: "h-7 w-7 rounded-lg flex items-center justify-center text-slate-400 hover:text-slate-600 hover:bg-muted transition-colors duration-150",
  closeIcon: "h-4 w-4",
  ...
  priceInputBase: "w-full h-11 rounded-2xl bg-background border border-border text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-200 transition-colors duration-150",
...
export const chaletDetail = {
  ...
  heroSaveActive: "text-heart fill-heart",
  heroSaveInactive: "text-slate-500",
  heroShare: "absolute top-3 right-14 rtl:right-auto rtl:left-14 z-10 h-9 w-9 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center shadow-sm border border-border transition-colors duration-150",
  ...
  calendarNavBtn: "h-8 w-8 rounded-xl flex items-center justify-center text-slate-500 hover:bg-muted transition-colors duration-150",
