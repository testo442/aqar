 ...
 *
 * Surfaces: bg-card (#FFFFFF), bg-background (#F5F5F5), bg-muted (#EEEEEE)
 * Borders:  border-border (#E0E0E0)
 * Primary:  primary-600 (#0D7377) — brand teal
 * Radii:    cards/controls rounded-2xl (12px), pills rounded-full, inner rounded-xl (12px)
 * Shadows:  controls shadow-sm, cards/map shadow-soft
 * Font:     Noto Sans Arabic — headlines 900, body 400–600
 */
...
export const searchBar = {
  ...
  input: "flex-1 h-full bg-transparent text-sm text-slate-900 placeholder:text-slate-500 outline-none min-w-0",
  filterWrapLTR: "flex-shrink-0 pr-1.5",
  filterWrapRTL: "flex-shrink-0 pl-1.5",
  filterBtn: "flex items-center gap-1.5 h-9 px-3.5 bg-primary-600 hover:bg-primary-700 text-white text-xs font-semibold rounded-xl transition-colors duration-150",
  ...
  dropdownItem: "flex items-center gap-2 px-4 py-2.5 text-sm text-slate-600 hover:bg-muted transition-colors duration-150 cursor-pointer first:rounded-t-2xl last:rounded-b-2xl",
  dropdownItemIcon: "h-3.5 w-3.5 text-slate-500 flex-shrink-0",
  dropdownItemText: "truncate",
  dropdownItemSub: "text-[11px] text-slate-500 ml-auto flex-shrink-0",
} as const
...
export const mapCard = {
  ...
  tapLabel: "absolute top-2.5 left-3 rtl:left-auto rtl:right-3 z-20 pointer-events-none flex items-center gap-1.5 bg-card/95 backdrop-blur-sm text-slate-600 text-[11px] rtl:text-[12px] font-medium px-2.5 py-1.5 rounded-full shadow-sm border border-border",
  ...
  previewPriceBadge: "absolute bottom-1.5 right-1.5 bg-card/95 backdrop-blur-sm text-primary-600 text-xs font-bold px-2 py-0.5 rounded-full shadow-sm border border-border",
  previewBody: "px-2.5 py-2 space-y-0.5",
  previewPrice: "text-[13px] font-bold text-primary-600",
  previewSuffix: "text-[10px] font-normal text-slate-500",
  ...
  cta: "inline-flex items-center gap-1.5 bg-primary-600 hover:bg-primary-700 text-white text-xs rtl:text-[13px] font-semibold px-3.5 py-2 rounded-full shadow-sm transition-colors duration-150",
  ctaIcon: "h-3.5 w-3.5",
  ...
  focusHint: "absolute inset-x-0 bottom-10 z-20 flex justify-center pointer-events-none opacity-0 transition-opacity duration-150",
...
export const listingsPage = {
  ...
  summaryCount: "text-sm text-slate-500 rtl:text-[14px]",
  // Filter chips
  chipsScroll: "flex gap-2 overflow-x-auto scrollbar-hide pb-1 -mx-5 px-5",
  chip: "flex-shrink-0 flex items-center gap-1 px-3 py-1.5 rounded-full bg-card border border-border text-xs font-medium text-slate-600 shadow-sm whitespace-nowrap rtl:text-[13px]",
  ...
  sortLabel: "text-xs text-slate-500 rtl:text-[13px]",
  sortSelect: "text-xs font-semibold text-slate-600 bg-transparent outline-none cursor-pointer rtl:text-[13px]",
  saveBtn: "flex items-center gap-1 text-xs font-semibold text-primary-600 hover:text-primary-700 transition-colors duration-150 rtl:text-[13px]",
  saveIcon: "h-3.5 w-3.5",
  // Listing grid
  gridWrap: "-mx-4",
  grid: "grid grid-cols-2 gap-2.5 px-4 md:grid-cols-3 lg:grid-cols-4",
  // Full listing card
  card: "bg-card rounded-2xl overflow-hidden border border-border shadow-soft flex flex-col transition-shadow duration-150",
  cardFeaturedWrap: "bg-card rounded-2xl overflow-hidden border-[1.5px] border-primary-400 shadow-lg flex flex-col ring-1 ring-primary-300/40 transition-shadow duration-150",
  cardImageWrap: "relative w-full",
  cardImageAspect: { aspectRatio: "4/3" } as React.CSSProperties,
  cardImage: "object-cover",
  cardHeart: "absolute top-2 right-2 rtl:right-auto rtl:left-2 z-10 h-7 w-7 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center shadow-sm border border-border transition-colors duration-150",
  cardHeartIcon: "h-3.5 w-3.5",
  cardHeartActive: "text-heart fill-heart",
  cardHeartInactive: "text-slate-500",
  ...
  cardPrice: "text-[14px] font-bold text-primary-600 leading-snug",
  cardPriceSuffix: "text-[11px] font-normal text-slate-500",
  ...
  mapCta: "fixed bottom-[4.5rem] left-1/2 -translate-x-1/2 z-30 md:bottom-6 inline-flex items-center gap-1.5 bg-card hover:bg-muted text-slate-600 text-sm font-semibold px-5 py-2.5 rounded-full shadow-sm border border-border transition-all duration-150",
  mapCtaActive: "fixed bottom-[4.5rem] left-1/2 -translate-x-1/2 z-30 md:bottom-6 inline-flex items-center gap-1.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold px-5 py-2.5 rounded-full shadow-lg transition-all duration-150",
  mapCtaIcon: "h-4 w-4",
} as const
...
export const mapPage = {
  ...
  resultPrice: "text-[13px] font-bold text-primary-600 leading-snug",
  resultPriceSuffix: "text-[11px] font-normal text-slate-500",
  resultTitle: "text-[11px] font-medium text-slate-600 line-clamp-1 rtl:text-[12px]",
  resultMeta: "text-[10px] text-slate-500 rtl:text-[11px]",
  ...
  listCta: "inline-flex items-center gap-1.5 bg-card/95 backdrop-blur-sm hover:bg-muted text-slate-600 text-xs font-semibold px-4 py-2 rounded-full shadow-sm border border-border transition-all duration-150 pointer-events-auto",
...
export const applyPage = {
  ...
  sectionSub: "text-xs text-slate-500 rtl:text-[13px]",
  // Form field
  label: "block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5 rtl:text-[12px] rtl:tracking-normal",
  input: "w-full h-11 rounded-2xl bg-background border border-border text-sm text-slate-900 placeholder:text-slate-500 outline-none px-4 focus:border-primary-400 focus:ring-1 focus:ring-primary-200 transition-colors duration-150",
  ...
  typeChip: "px-4 py-2.5 rounded-2xl text-sm font-medium border transition-colors duration-150 bg-background border-border text-slate-600 hover:border-slate-400",
  typeChipActive: "px-4 py-2.5 rounded-2xl text-sm font-medium border transition-colors duration-150 bg-primary-600 text-white border-primary-600",
  // Stepper
  stepperRow: "flex items-center gap-3",
  stepperBtn: "h-9 w-9 rounded-xl border border-border bg-background text-slate-600 flex items-center justify-center text-lg font-semibold hover:bg-muted transition-colors duration-150",
  ...
  toggleTrack: "relative inline-flex w-[44px] h-[24px] rounded-full transition-colors duration-150 cursor-pointer flex-shrink-0",
  ...
  photoAdd: "w-20 h-20 rounded-xl border-2 border-dashed border-border bg-background flex-shrink-0 flex flex-col items-center justify-center gap-1 text-slate-500 hover:text-slate-600 hover:border-slate-400 transition-colors duration-150 cursor-pointer",
  ...
  mapLocateBtn: "flex items-center gap-1.5 text-xs font-semibold text-primary-600 hover:text-primary-700 transition-colors duration-150",
  mapLocateIcon: "h-3.5 w-3.5",
  mapCoords: "text-[11px] text-slate-500 tabular-nums mt-1.5",
  // Terms
  ...
  // Actions
  submitBtn: "w-full h-12 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors duration-150",
  draftBtn: "w-full h-11 rounded-2xl border border-border text-sm font-semibold text-slate-600 hover:bg-muted transition-colors duration-150",
} as const
...
export const propertyDetail = {
  ...
  container: "w-full max-w-[600px] md:max-w-3xl lg:max-w-5xl mx-auto",
  // Back row
  backRow: "px-5 py-3 flex items-center gap-2",
  backBtn: "inline-flex items-center gap-1.5 text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors duration-150 rtl:text-[14px]",
  ...
  heroSave: "absolute top-3 right-3 rtl:right-auto rtl:left-3 z-10 h-11 w-11 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center shadow-sm border border-border transition-colors duration-150",
  heroSaveIcon: "h-4 w-4",
  heroSaveActive: "text-heart fill-heart",
  ...
  price: "text-xl font-bold text-primary-600 leading-tight",
  priceSuffix: "text-sm font-normal text-slate-500",
  title: "text-base font-semibold text-slate-900 leading-snug rtl:text-[17px]",
  ...
  actionPrimary: "flex-1 h-11 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors duration-150 flex items-center justify-center gap-2",
  actionSecondary: "h-11 w-11 rounded-2xl border border-border bg-card hover:bg-muted flex items-center justify-center transition-colors duration-150",
  ...
  factLabel: "text-[11px] text-slate-500 rtl:text-[12px]",
  ...
  mapLocationIcon: "h-3.5 w-3.5 text-slate-500 flex-shrink-0",
  ...
  stickyInner: "max-w-[600px] md:max-w-3xl lg:max-w-5xl mx-auto px-5 py-3 flex items-center gap-3",
  stickyPrimary: "flex-1 h-11 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors duration-150 flex items-center justify-center gap-2",
  stickySecondary: "h-11 px-5 rounded-2xl border border-border bg-card hover:bg-muted text-sm font-semibold text-slate-600 transition-colors duration-150 flex items-center justify-center gap-2",
  stickySecondaryIcon: "h-4 w-4",
  stickyPrice: "text-sm font-bold text-primary-600",
  stickyPriceSuffix: "text-xs font-normal text-slate-500",
} as const

// ─── Filter Sheet ────────────────────────────────────────────────────────────
export const filterSheet = {
  backdrop: "fixed inset-0 z-40 bg-black/25 transition-opacity duration-150",
  backdropOpen: "opacity-100 pointer-events-auto",
  backdropClosed: "opacity-0 pointer-events-none",
  sheet: "fixed bottom-0 left-0 right-0 z-50 flex flex-col bg-card rounded-t-2xl shadow-soft-xl max-h-[85vh] transition-transform duration-150 ease-out",
  ...
  closeBtn: "h-10 w-10 -mr-2 rtl:-mr-0 rtl:-ml-2 rounded-xl flex items-center justify-center text-slate-600 hover:text-slate-900 hover:bg-muted transition-colors duration-150",
  closeIcon: "h-4 w-4",
  ...
  pricePrefixLTR: "absolute top-1/2 -translate-y-1/2 text-xs font-semibold text-slate-500 left-3.5",
  pricePrefixRTL: "absolute top-1/2 -translate-y-1/2 text-xs font-semibold text-slate-500 right-3.5",
  priceInputBase: "w-full h-11 rounded-2xl bg-background border border-border text-sm text-slate-900 placeholder:text-slate-500 outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-200 transition-colors duration-150",
  priceInputLTR: "pl-10 pr-4",
  priceInputRTL: "pr-10 pl-4",
  chipRow: "flex flex-wrap gap-2",
  chipActive: "px-4 py-2 rounded-2xl text-sm font-medium border transition-colors duration-150 bg-primary-600 text-white border-primary-600",
  chipInactive: "px-4 py-2 rounded-2xl text-sm font-medium border transition-colors duration-150 bg-background border-border text-slate-600 hover:border-slate-400",
  footer: "flex gap-3 px-5 py-4 border-t border-border flex-shrink-0 pb-safe",
  clearBtn: "flex-1 h-11 rounded-2xl border border-border text-sm font-semibold text-slate-600 hover:bg-muted transition-colors duration-150",
  applyBtn: "flex-1 h-11 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors duration-150",
} as const
...
export const khiranPage = {
  ...
  heroTitle: "text-lg font-black text-white leading-tight rtl:text-xl",
  ...
  packageTabInactive: "text-slate-500 hover:text-slate-600",
  // Filter row (inline, compact)
  filterRow: "flex gap-2 overflow-x-auto scrollbar-hide pb-1 -mx-5 px-5 mb-3",
  filterChip: "flex-shrink-0 flex items-center gap-1 px-3 py-1.5 rounded-full bg-card border border-border text-xs font-medium text-slate-600 shadow-sm whitespace-nowrap rtl:text-[13px]",
  ...
  cardVerified: "absolute top-2 right-2 rtl:right-auto rtl:left-2 z-10 bg-primary-600 text-white text-[9px] font-bold px-2 py-0.5 rounded-full shadow-sm",
  ...
  cardRating: "text-[11px] font-semibold text-slate-600",
  cardReviews: "text-[11px] text-slate-500",
  cardMeta: "text-[11px] text-slate-500 leading-snug rtl:text-[12px]",
  cardAmenities: "flex items-center gap-2 pt-0.5",
  cardAmenity: "flex items-center gap-0.5 text-[10px] text-slate-500 rtl:text-[11px]",
  cardAmenityIcon: "h-3 w-3 text-slate-500",
  cardBookBtn: "mt-auto pt-2",
  cardBookBtnInner: "w-full h-9 rounded-xl bg-primary-600 hover:bg-primary-700 text-white text-xs font-semibold transition-colors duration-150",
  // Chalet grid
...
export const chaletDetail = {
  ...
  heroSaveActive: "text-heart fill-heart",
  heroSaveInactive: "text-slate-500",
  heroShare: "absolute top-3 right-3 rtl:right-auto rtl:left-3 z-10 h-11 w-11 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center shadow-sm border border-border transition-colors duration-150",
  ...
  title: "text-lg font-black text-slate-900 leading-snug rtl:text-xl",
  locationRow: "flex items-center gap-1.5",
  locationIcon: "h-3.5 w-3.5 text-slate-500 flex-shrink-0",
  ...
  ratingCount: "text-xs text-slate-500",
  verifiedBadge: "inline-flex items-center gap-1 bg-primary-50 text-primary-600 text-[11px] font-semibold px-2.5 py-1 rounded-full border border-primary-200",
  ...
  amenityLabel: "text-sm font-medium text-slate-600 rtl:text-[14px]",
  ...
  pricingCard: "bg-card rounded-2xl border border-border p-3 space-y-1 cursor-pointer transition-all duration-150",
  pricingCardActive: "bg-card rounded-2xl border-[1.5px] border-primary-400 p-3 space-y-1 cursor-pointer transition-all duration-150 ring-1 ring-primary-300/40 shadow-sm",
  ...
  pricingPrice: "text-base font-bold text-primary-600",
  pricingPriceActive: "text-base font-bold text-primary-600",
  pricingSuffix: "text-[11px] font-normal text-slate-500",
  pricingNote: "text-[10px] text-slate-500 rtl:text-[11px]",
  // Calendar section
  calendarSection: "px-5 py-4 space-y-3",
  calendarTitle: "text-sm font-bold text-slate-900 rtl:text-[15px]",
  calendarSub: "text-xs text-slate-500 rtl:text-[13px]",
  calendarCard: "bg-card rounded-2xl border border-border p-4 shadow-soft",
  calendarNav: "flex items-center justify-between mb-3",
  calendarNavBtn: "h-10 w-10 rounded-xl flex items-center justify-center text-slate-600 hover:bg-muted transition-colors duration-150",
  ...
  calendarWeekDay: "text-center text-[10px] font-semibold text-slate-500 py-1 uppercase",
  calendarGrid: "grid grid-cols-7",
  calendarDay: "relative h-9 flex items-center justify-center text-sm text-slate-600 cursor-pointer rounded-lg hover:bg-muted transition-colors duration-150",
  calendarDayToday: "relative h-9 flex items-center justify-center text-sm font-semibold text-primary-600 cursor-pointer rounded-lg hover:bg-muted transition-colors duration-150",
  ...
  calendarLegendItem: "flex items-center gap-1.5 text-[10px] text-slate-500",
  ...
  datesSummaryNights: "text-xs text-slate-500 rtl:text-[13px]",
  // Map section
  mapSection: "px-5 py-4 space-y-3",
  mapTitle: "text-sm font-bold text-slate-900 rtl:text-[15px]",
  mapWrap: "w-full h-[180px] rounded-2xl border border-border overflow-hidden",
  ...
  stickyPrice: "text-sm font-bold text-primary-600",
  stickyPriceSuffix: "text-xs font-normal text-slate-500",
  stickyDates: "text-[11px] text-slate-500 truncate",
  stickyPrimary: "flex-1 h-11 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold transition-colors duration-150 flex items-center justify-center gap-2",
  stickySecondary: "h-11 w-11 rounded-2xl border border-border bg-card hover:bg-muted flex items-center justify-center transition-colors duration-150 flex-shrink-0",
